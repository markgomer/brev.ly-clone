   ...
   return (
      <Routes>
         <Route
            path="/"
            element={
               <div className="h-screen overflow-hidden bg-gray-100 px-4 py-4 \
                  flex flex-col">
                  ...
                  <main className="max-w-4xl w-full mx-auto flex flex-col \
                     md:flex-row gap-4 items-start flex-1 min-h-0">
